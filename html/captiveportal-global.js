document.addEventListener('DOMContentLoaded', function() {
    ...
    var liMenu = document.querySelectorAll('#apps a')
      , colors = ['redbg','purpledarkbg','darkbluebg','orangebg','greenbg','lightpinkbg','purpledarkbg','yellowbg','lightpinkbg','pinkbg','turquoisebg','yellowbg','lightbluebg','purpledarkbg', 'bluebg']
